...
public class Q2 {
    ...
    public static void scheme1() {
        SoutUtils.soutln(str.toString());//abcdefgh

        //置逆0至i位置的内容
        reverse(0, i);
        SoutUtils.soutln(str.toString());//cbadefgh

        //置逆i至n位置的内容
        reverse(i, n);
        SoutUtils.soutln(str.toString());//cbahgfed

        //置逆0只n位置的内容
        reverse(0, n);
        SoutUtils.soutln(str.toString());//defghabc
    }
